...
PROP_VALUE_FIGURE_COORD               = 1
PROP_VALUE_FIGURE_DIAGRAM             = 2
PROP_VALUE_FIGURE_REMOVE_CAPTURED_OFF = 256
PROP_VALUE_FIGURE_HOSHI_OFF           = 512
PROP_VALUE_FIGURE_IGNORE_FLAGS        = 32768
PROP_VALUE_PRINT_MODE_NO_NUMBER       = 0
PROP_VALUE_PRINT_MODE_AS_IS           = 1
PROP_VALUE_PRINT_MODE_MODULO_100      = 2
PROP_VALUE_MOVE_PASS_COORD            = "tt" # for FF[3]